...
exports.default = function (props) {
  ...
  var _getBandStyle = (0, _styleHelpers.getBandStyle)(theme, props.bandStyle),
      backgroundColor = _getBandStyle.backgroundColor,
      textColor = _getBandStyle.textColor,
      activeColor = _getBandStyle.activeColor,
      contentStyle = _getBandStyle.contentStyle,
      titleStyle = _getBandStyle.titleStyle,
      subtitleStyle = _getBandStyle.subtitleStyle,
      imageStyle = _getBandStyle.imageStyle,
      buttonStyle = _getBandStyle.buttonStyle,
      textColumnStyle = _getBandStyle.textColumnStyle,
      imageColumnStyle = _getBandStyle.imageColumnStyle;
